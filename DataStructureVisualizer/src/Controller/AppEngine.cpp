...
namespace {
    ...
    std::vector<Edge> generateRandomEdges(int vertexCount, int edgeCount,
        ...
        AlgorithmType resolveAlgorithmForAction(StructureType structureType,
            int action) {
